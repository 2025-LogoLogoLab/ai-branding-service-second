...
import com.example.logologolab.exception.ExampleHolder;
import com.example.logologolab.exception.annotation.ApiErrorCodeExample;
import com.example.logologolab.exception.annotation.ApiErrorCodeExamples;
...
public class SwaggerConfig {
    @Bean
    public GroupedOpenApi logologolabApi() {
        return GroupedOpenApi.builder()
                .group("logologolab-api")
    ...
    @Bean
    public OpenAPI logologolabOpenAPI() {
        return new OpenAPI()
                .addServersItem(new Server().url("https://logologolab.duckdns.org"))
                .info(new Info()
                        .title("logologolab API")
                        .version("v1")
                        .description("logologolab API 명세서"));
    }
